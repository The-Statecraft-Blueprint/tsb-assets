...
- **Member counts vary by Congress:** Voteview's member file includes everyone who served and cast roll-call votes during a Congress, including members who filled a seat mid-term after a death, resignation, or special election. This means the denominator for a given Congress is sometimes above the nominal 435 seats (e.g. the 111th Congress has 452 House D+R members on file). This is the standard Voteview convention and is not an error.
- **Real volatility:** The recomputed series is not monotonic. Reading Congress-over-Congress, the moderate share of the House rose (rather than fell) in eight of the twenty-seven transitions in this series — 1977, 1987, 1989, 1999, 2007, 2009, 2019, and 2025. The clearest example is 2007–2011: moderate share rose from 12.6% (109th) to 13.8% (110th) to 16.5% (111th), then fell sharply to 8.8% (112th). This chart does not attempt to explain those reversals — it only reports them, since they are real and were absent from the earlier fabricated version of this chart.
...
- 1971: 40.1% of House members were moderates (92nd Congress) — direct calculation from Voteview data
- 2025: 8.7% of House members were moderates (119th Congress, provisional — still in session)
- 2013: 8.8% of House members were moderates (113th Congress)
